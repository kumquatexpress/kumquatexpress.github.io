var constants = {
    image_text: {
        ...
        vroom: {
            text: "<p><h5>Vroom</h5>A static website generator and framework written in Golang and using the Go template engine. Built because I wanted to make a Golang solution for something as flexible and useful as Jekyll. Open sourced and in use on Github! Spring 2015.</p>"
        },
    },
    urls: {
